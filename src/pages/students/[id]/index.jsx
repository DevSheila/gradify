        ...
        <CardContent>
          <dl className="grid grid-cols-2 gap-4">
            <div>
              ...
              <dd className="text-muted-foreground">{student?.studentId}</dd>
            </div>
            <div>
              <dt className="font-medium">Full Name</dt>
              <dd className="text-muted-foreground">{student?.fullName}</dd>
            </div>
            <div>
            ...
            <div className="col-span-2">
              <dt className="font-medium">School Address</dt>
              <dd className="text-muted-foreground">{student?.schoolAddress}</dd>
            </div>
            <div>
              <dt className="font-medium">School Phone</dt>
              <dd className="text-muted-foreground">{student?.schoolPhone}</dd>
            </div>
            <div>
